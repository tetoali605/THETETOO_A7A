    ...
    if msgs > max_msg then
	  ...
	  if msg.to.type == 'chat' or msg.to.type == 'channel' then
		if username then
			...
			send_large_msg(receiver , "🎀🎖تـم الكـشف عـن وجـود تفليـش\n🎀🎖تـم طـرد العـظو\n🎀🎖يـرجي اتـبا؏ القـوانـين\n🎀🎖مـطور السـورس ابـو عسـوله  @l_l_lo   #معـرف المجرم   @"..username.."["..msg.from.id.."]\n")
		else
